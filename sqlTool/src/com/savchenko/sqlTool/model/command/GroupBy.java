...
//        }
//
//        var wrappedValues = table.dataStream().stream()
...
//
//
//        List<List<Value<?>>> dataStream = wrappedValues.stream()
//                .map(groupedRow -> {
...
//                }).toList();
//
//        var complexity = table.columns().size() * table.dataStream().size() * groupColumns.size();
//
...
//        var complexity = columns.size() * table.dataStream().size();
//
//        Function<Integer, ExpressionList> getColumnValues = index -> {
//            var list = table.dataStream().stream()
